...
struct Args {
	...
	#[clap(
		short,
		long,
		default_value = "https://github.com/aleixcanalda/beacon-v2/models/json/beacon-v2-default-model"
	)]
	model: Url,
	...
	#[clap(
		short, 
		long, 
		default_value = "https://github.com/aleixcanalda/beacon-v2/framework/json")]
	framework: Url,
